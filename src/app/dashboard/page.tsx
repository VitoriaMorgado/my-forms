...
export default function Dashboard() {
    ...
    const handleSave = (id: number) => {
        setGames((prev) =>
            prev.map((game) =>
                game.id === id ? { ...game, ...editForm, id } : game
            )
        );
        setEditingId(null);
        setEditForm({});
    ...
    return (
      ...
      <div className="container mx-auto p-4 bg-gray-900 w-full">
        ...
        <section className="bg-gradient-to-br from-gray-800 to-gray-900 text-gray-100 rounded-2xl p-8 mb-10 shadow-xl max-w-3xl mx-auto border border-gray-700">
          ...
          <ul className="list-disc pl-8 mb-4 space-y-1 text-base">
            <li>
              Permite integração entre diferentes plataformas e linguagens.
            </li>
            <li>
              Facilita o acesso a funcionalidades ou dados de um sistema de
              forma controlada.
            </li>
            <li>
          ...
          <p className="italic text-gray-300">
            <span className="text-blue-400 font-semibold">Exemplo:</span> Um
            site pode usar uma API para buscar dados de jogos em um servidor e
        ...
        <div className="bg-yellow-900 border-l-4 border-yellow-400 p-4 mb-6 max-w-3xl mx-auto rounded-lg shadow">
            ...
            <p className="text-gray-200">
                O método <span className="font-semibold text-yellow-300">PUT</span> é utilizado para <span className="font-semibold">atualizar dados existentes</span> em uma API. Ele permite que o frontend envie informações modificadas para o backend, substituindo os dados antigos por novos.
                <br />
                <span className="text-yellow-300 font-semibold">Exemplo:</span> Ao clicar em ALTERAR em um jogo, você pode editar seus dados. Ao salvar, é feita uma requisição PUT para atualizar as informações desse jogo no servidor.
            </p>
        </div>
        ...
        <div className="bg-red-900 border-l-4 border-red-500 p-4 mb-6 max-w-3xl mx-auto rounded-lg shadow">
            ...
            <p className="text-gray-200">
                O método <span className="font-semibold text-red-400">DELETE</span> é utilizado para <span className="font-semibold">remover dados existentes</span> em uma API. Ele permite que o frontend solicite ao backend a exclusão de um recurso, como um jogo cadastrado.
                <br />
                <span className="text-red-400 font-semibold">Exemplo:</span> Ao clicar em EXCLUIR em um jogo, é feita uma requisição DELETE para remover esse jogo do servidor e da lista exibida.
            </p>
        </div>
            ...
            <tbody>
              {games.map((game) => (
                ...
                <section className="bg-gradient-to-br from-gray-800 to-gray-900 text-gray-100 rounded-2xl p-8 mb-10 shadow-xl max-w-3xl mx-auto border border-gray-700">
                    ...
                    <p className="mb-4 text-lg leading-relaxed">
                        <span className="font-semibold text-purple-300">Designer de API</span> refere-se ao processo de planejar, estruturar e documentar como uma API será construída e utilizada. Um bom design garante que a API seja <span className="font-semibold">fácil de entender</span>, <span className="font-semibold">consistente</span> e <span className="font-semibold">segura</span> para desenvolvedores e sistemas que irão utilizá-la.
                    </p>
                    <ul className="list-disc pl-8 mb-4 space-y-1 text-base">
                        <li>
                            Define os <span className="text-purple-300">endpoints</span>, métodos HTTP e formatos de dados.
                        </li>
                        <li>
                            Facilita a integração entre diferentes aplicações e equipes.
                        </li>
                        <li>
                            Ajuda a evitar ambiguidades e erros de comunicação entre frontend e backend.
                        </li>
                        <li>
                            Inclui boas práticas como versionamento, documentação clara e tratamento de erros.
                        </li>
                    </ul>
                    <p className="italic text-gray-300">
                        <span className="text-purple-400 font-semibold">Exemplo:</span> Antes de implementar a API de jogos, é importante definir como serão as rotas, quais dados cada operação espera e retorna, e como os erros serão tratados, garantindo uma experiência melhor para quem consome a API.
                    </p>
                </section>
      </div>
    );
